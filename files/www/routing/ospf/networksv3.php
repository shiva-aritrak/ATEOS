...
if(count($_GET) > 0) {
  ...
  $ospf_net_no = str_replace("net", "", $filled_ospf_network);
	$filled_ospf_network = $_GET["ospf_network"];
  if ($action == "delete") {
    delete_ospf_networks($filled_ospf_network, $ospf_network, 1);
          ...
          <div class="panel">
            <div class="panel-body">
              <div class="panel-heading">
                <h3 class="panel-title">Add/Edit OSPFv3 Network</h3>
              </div>
              <div class="panel-body">
                <form enctype="multipart/form-data" id="ospf_networks_form" action="networksv3.php" method="post">
                  ...
                  <table>
                    <tr>
                      <td>Name</td>
                      <td><input type="text" id="network_name_id" name="network_name" class="form-control" value="<?php  echo exec("uci get bird6.".$filled_ospf_network.".name");?>"></td>
                    </tr>
                    <tr>
                      <td>Network Subnet</td>
                      <td><input type="text" id="net_sub_id" name="network_subnet" class="form-control" value="<?php  echo exec("uci get bird6.".$filled_ospf_network.".range");?>"></td>
                    </tr>
                  </table>
                  <br/>
                  <div class="row">
